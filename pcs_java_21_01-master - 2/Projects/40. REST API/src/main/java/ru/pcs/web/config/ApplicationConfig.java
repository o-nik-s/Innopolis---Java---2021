...
@ComponentScan(basePackages = "ru.pcs.web")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = "ru.pcs.web.repositories")
@EnableWebMvc
public class ApplicationConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        entityManagerFactory.setPackagesToScan("ru.pcs.web.models");
